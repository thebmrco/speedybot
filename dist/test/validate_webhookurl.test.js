...
// ex. bad: https://123-456-789.ngrok.io
tape_1.default("Should return true if valid", function (t) {
    var webhookUrl = 'https://123-456-789.ngrok.io/webhookroute';
    var expected = true;
    var actual = helpers_1.ValidatewebhookUrl(webhookUrl);
    t.deepEqual(actual, expected);
    t.end();
});
tape_1.default("Should throw if no ending path", function (t) {
...
tape_1.default("Should throw if no ending path, ends in slash", function (t) {
    var webhookUrl = 'https://123-456-789.ngrok.io/';
    try {
        helpers_1.ValidatewebhookUrl(webhookUrl);
        t.fail('Should throw error');
