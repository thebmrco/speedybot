...
(0, tape_1.default)("Should pick a random choice and fill the template", function (t) {
    var pass = false;
    var payload = {
    ...
    var res = (0, src_1.fillTemplate)(phrases, template);
...
(0, tape_1.default)("Should take a string & fill in the template (& not crash if key name happened to be contaied 😶)", function (t) {
    var pass = false;
    var payload = {
